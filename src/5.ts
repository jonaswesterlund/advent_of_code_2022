...
function executeSingleMoves(moves: any, stackArray: any) {
...
function executeMultipleMoves(moves: any, stackArray: any) {
  for(let move of moves) {
    let fromStack: string[] = stackArray[move.from-1];
    let toStack: string[] = stackArray[move.to-1];
...
function getTopCrates(stackArray: any) {
